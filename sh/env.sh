...
# below and assiging it the location of a valid GraalVM JDK 11 runtime.
#
# MacOS example
#export JAVA_HOME="~/IDE/graalvm-ee-java11-20.2.0/Contents/Home"
# Linux Example
#export JAVA_HOME="~/graalvm-ee-java11-20.2.0"
...
EXTERNAL_MODULES=(
    ...
    "$REPO/org/openjfx/javafx-base/$OPENJFX_VERSION/javafx-base-$OPENJFX_VERSION.jar"
    "$REPO/org/openjfx/javafx-controls/$OPENJFX_VERSION/javafx-controls-$OPENJFX_VERSION.jar"
    "$REPO/org/openjfx/javafx-fxml/$OPENJFX_VERSION/javafx-fxml-$OPENJFX_VERSION.jar"
    "$REPO/org/openjfx/javafx-graphics/$OPENJFX_VERSION/javafx-graphics-$OPENJFX_VERSION.jar"
    "$REPO/org/openjfx/javafx-base/$OPENJFX_VERSION/javafx-base-$OPENJFX_VERSION-$PLATFORM.jar"
    "$REPO/org/openjfx/javafx-controls/$OPENJFX_VERSION/javafx-controls-$OPENJFX_VERSION-$PLATFORM.jar"
    "$REPO/org/openjfx/javafx-fxml/$OPENJFX_VERSION/javafx-fxml-$OPENJFX_VERSION-$PLATFORM.jar"
    "$REPO/org/openjfx/javafx-graphics/$OPENJFX_VERSION/javafx-graphics-$OPENJFX_VERSION-$PLATFORM.jar"
)
